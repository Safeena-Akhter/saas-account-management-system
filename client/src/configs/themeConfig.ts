...
const themeConfig: Config = {
  templateName: 'AccounTrack',
  // Used only as a loop-prevention fallback (see AuthRedirect.tsx) - the
  // real post-login destination is role-specific, computed by
  // `getHomeRouteForRole()` in `src/utils/roleRoutes.ts`.
  homePageUrl: '/dashboards/employee',
