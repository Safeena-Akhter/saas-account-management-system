            ...
            >
              <ClickAwayListener onClickAway={e => handleDropdownClose(e as MouseEvent | TouchEvent)}>
                <MenuList>
                  ...
                  {/* Settings (UC-53/54) is now a real page - see
                      views/settings/SettingsPage.tsx. Pricing/FAQ were
                      intentionally left out in Phase 0 (they pointed at
                      template demo pages) and belong on the public landing
                      site, not this dropdown. */}
